...
Example.args = {
  classes: ['position-relative', 'p-5', 'bg-secondary', 'text-bg-primary', 'bg-gradient'],
...
ExampleFixedBackground.args = {
  ...Example.args,
  classes: ['section--photo', 'section--fixed-background', 'text-white', 'text-center', 'px-3', 'py-9'],
...
Example2.args = {
  ...Example.args,
  classes: ['section--fade-photo', 'p-5', 'text-white'],
  heading: '',
...
Example3.args = {
  ...Example.args,
  classes: ['section--linear-primary', 'p-5', 'text-white'],
}
...
Example4.args = {
  ...Example.args,
  classes: ['bg-red', 'bg-gradient', 'text-bg-red', 'p-5'],
  heading: '',
